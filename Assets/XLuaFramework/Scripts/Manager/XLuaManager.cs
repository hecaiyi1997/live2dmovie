...
public class XLuaManager : MonoBehaviour
{
    ...
    public Action onMoveStart = null; 
    public Action finishplayaction = null;
    public Action onsceneloadedTrgger = null; 
    public Action talkDialogcompleted = null;
    ...
    public void InitLuaEnv()
    {
        ...
        if (luaEnv != null)
        {
            ...
            onMoveStart= luaEnv.Global.Get<Action>("onMoveStart");
            finishplayaction = luaEnv.Global.Get<Action>("finishplayaction");
            talkDialogcompleted += luaEnv.Global.Get<Action>("talkDialogcompleted");
    ...
    private byte[] LoaderByAB(ref string fileName)
    {
        ...
        if (Application.platform == RuntimePlatform.WindowsEditor)
        {
            ...
            Debug.Log("Load lua script : " + scriptPath2);//从D:/Users/Movie/Assets/lua/文件夹下取
