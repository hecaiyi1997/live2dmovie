    ...
    public class Main : MonoBehaviour {
        ...
        void Start() {
            ...
            */
            ...
            this.gameObject.AddComponent<MovePlayManager>();
        ...
        private void Update() 
        {
            ...
            switch(cur_state)
            {
                ...
                case State.Playing://加载monster
                    ...
                    XLuaManager.Instance.onStartTrgger.Invoke();//这句话一定要在玩家加载完成之后 lua 方面触发GlobalEventSystem:Fire(GlobalEvents.GameStart)
