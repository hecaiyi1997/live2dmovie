...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosRatioByWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Cocos.RatioBy);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					Cocos.RatioBy gen_ret = new Cocos.RatioBy();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.RatioBy constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<Cocos.CoordinateStyle>(L, 3)) 
                {
                    float _duration = (float)LuaAPI.lua_tonumber(L, 1);
                    float _deltaRatio = (float)LuaAPI.lua_tonumber(L, 2);
                    Cocos.CoordinateStyle _style;translator.Get(L, 3, out _style);
                    
                        Cocos.RatioBy gen_ret = Cocos.RatioBy.Create( _duration, _deltaRatio, _style );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    float _deltaRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        Cocos.RatioBy gen_ret = Cocos.RatioBy.Create( _duration, _deltaRatio );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Cocos.RatioBy.Create!");
		    ...
		    try {
                ...
                
                {
                    ...
                    float _deltaRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        Cocos.RatioBy gen_ret = Cocos.RatioBy.CreateLocal( _duration, _deltaRatio );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _deltaRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        Cocos.RatioBy gen_ret = Cocos.RatioBy.CreateAbs( _duration, _deltaRatio );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _deltaRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        Cocos.RatioBy gen_ret = Cocos.RatioBy.CreateAnchored( _duration, _deltaRatio );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Clone(RealStatePtr L)
        {
		    try {
                ...
                Cocos.RatioBy gen_to_be_invoked = (Cocos.RatioBy)translator.FastGetCSObj(L, 1);
