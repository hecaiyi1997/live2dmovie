        ...
        static int _m_StartPreLoadRes(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    System.Action<bool> _onOk = translator.GetDelegate<System.Action<bool>>(L, 3);
                    
                    gen_to_be_invoked.StartPreLoadRes( _on_update, _onOk );
        ...
        static int _m_LoadMaterial(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    gen_to_be_invoked.LoadMaterial( _path, _storeName );
