...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOSceneMgrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 27, 14, 6);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "StopAllTimeline", _m_StopAllTimeline);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "reliveMainRolesafe", _m_reliveMainRolesafe);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "reliveMainRolelocal", _m_reliveMainRolelocal);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RecordSceneObjectsingleTerrain", _m_RecordSceneObjectsingleTerrain);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddSceneObjectsingleTerrain", _m_AddSceneObjectsingleTerrain);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "AddSceneObjectsingle", _m_AddSceneObjectsingle);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ChangeRoleUID", _m_ChangeRoleUID);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "SceneObjContainer", _g_get_SceneObjContainer);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "CurSceneID", _g_get_CurSceneID);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "worldmgr", _g_get_worldmgr);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "CurSceneID", _s_set_CurSceneID);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "worldmgr", _s_set_worldmgr);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_StopAllTimeline(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.StopAllTimeline(  );
        ...
        static int _m_ReqEnterScene(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    gen_to_be_invoked.ReqEnterScene( _scene_id );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.SceneMgr.ReqEnterScene!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_reliveMainRolesafe(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.reliveMainRolesafe(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_reliveMainRolelocal(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.reliveMainRolelocal(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RecordSceneObjectsingleTerrain(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RecordSceneObjectsingleTerrain( _uid, _typeID, _pos, _targetPos, _curHp, _maxHp );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddSceneObjectsingleTerrain(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddSceneObjectsingleTerrain( _uid, _typeID, _pos, _targetPos, _curHp, _maxHp );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_AddSceneObjectsingle(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    float _maxHp = (float)LuaAPI.lua_tonumber(L, 7);
                        ...
                        Unity.Entities.Entity gen_ret = gen_to_be_invoked.AddSceneObjectsingle( _uid, _typeID, _pos, _targetPos, _curHp, _maxHp );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_ChangeRoleUID(RealStatePtr L)
        {
		    try {
                ...
                {
                    Unity.Entities.Entity _entity;translator.Get(L, 2, out _entity);
                    long _newUID = LuaAPI.lua_toint64(L, 3);
                    
                    gen_to_be_invoked.ChangeRoleUID( _entity, _newUID );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_SceneObjContainer(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityMMO.SceneMgr gen_to_be_invoked = (UnityMMO.SceneMgr)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.SceneObjContainer);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_CurSceneID(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.SceneMgr gen_to_be_invoked = (UnityMMO.SceneMgr)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.CurSceneID);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_worldmgr(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityMMO.SceneMgr gen_to_be_invoked = (UnityMMO.SceneMgr)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.worldmgr);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_CurSceneID(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.SceneMgr gen_to_be_invoked = (UnityMMO.SceneMgr)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.CurSceneID = LuaAPI.xlua_tointeger(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_worldmgr(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityMMO.SceneMgr gen_to_be_invoked = (UnityMMO.SceneMgr)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.worldmgr = (UnityMMO.WorldManager)translator.GetObject(L, 2, typeof(UnityMMO.WorldManager));
