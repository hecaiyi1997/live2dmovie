...
namespace XLua.CSObjectWrap
{
    ...
    public class CocosCoordinateStyleWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(Cocos.CoordinateStyle), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(Cocos.CoordinateStyle), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(Cocos.CoordinateStyle), L, null, 4, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Local", Cocos.CoordinateStyle.Local);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Abs", Cocos.CoordinateStyle.Abs);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Anchored", Cocos.CoordinateStyle.Anchored);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(Cocos.CoordinateStyle), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushCocosCoordinateStyle(L, (Cocos.CoordinateStyle)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushCocosCoordinateStyle(L, Cocos.CoordinateStyle.Local);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Abs"))
                {
                    translator.PushCocosCoordinateStyle(L, Cocos.CoordinateStyle.Abs);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Anchored"))
                {
                    translator.PushCocosCoordinateStyle(L, Cocos.CoordinateStyle.Anchored);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for Cocos.CoordinateStyle!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for Cocos.CoordinateStyle! Expect number or string, got + " + lua_type);
            }
    ...
    public class UnityMMOSceneInfoKeyWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityMMO.SceneInfoKey), L, null, 14, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Buff", UnityMMO.SceneInfoKey.Buff);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Speed", UnityMMO.SceneInfoKey.Speed);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Exp", UnityMMO.SceneInfoKey.Exp);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Talk", UnityMMO.SceneInfoKey.Talk);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                {
                    translator.PushUnityMMOSceneInfoKey(L, UnityMMO.SceneInfoKey.Buff);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Speed"))
                {
                    translator.PushUnityMMOSceneInfoKey(L, UnityMMO.SceneInfoKey.Speed);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Exp"))
                {
                    translator.PushUnityMMOSceneInfoKey(L, UnityMMO.SceneInfoKey.Exp);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Talk"))
                {
                    translator.PushUnityMMOSceneInfoKey(L, UnityMMO.SceneInfoKey.Talk);
                }
				else
                {
    ...
    public class UnityMMOEffectStatusWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(UnityMMO.EffectStatus), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(UnityMMO.EffectStatus), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(UnityMMO.EffectStatus), L, null, 4, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "WaitForRender", UnityMMO.EffectStatus.WaitForRender);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Rendering", UnityMMO.EffectStatus.Rendering);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", UnityMMO.EffectStatus.None);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(UnityMMO.EffectStatus), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushUnityMMOEffectStatus(L, (UnityMMO.EffectStatus)LuaAPI.xlua_tointeger(L, 1));
            }
			
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {

			    if (LuaAPI.xlua_is_eq_str(L, 1, "WaitForRender"))
                {
                    translator.PushUnityMMOEffectStatus(L, UnityMMO.EffectStatus.WaitForRender);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Rendering"))
                {
                    translator.PushUnityMMOEffectStatus(L, UnityMMO.EffectStatus.Rendering);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "None"))
                {
                    translator.PushUnityMMOEffectStatus(L, UnityMMO.EffectStatus.None);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for UnityMMO.EffectStatus!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for UnityMMO.EffectStatus! Expect number or string, got + " + lua_type);
            }
    ...
    public class UnityMMONameboardDataResStateWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityMMO.NameboardData.ResState), L, null, 4, 0, 0);
