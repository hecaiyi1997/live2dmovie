...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaFrameworkNetworkManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.GETTER_IDX, "onApplyTalkExp", _g_get_onApplyTalkExp);
			...
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "onApplyTalkExp", _s_set_onApplyTalkExp);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onApplyTalkExp(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                XLuaFramework.NetworkManager gen_to_be_invoked = (XLuaFramework.NetworkManager)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.onApplyTalkExp);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onApplyTalkExp(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                XLuaFramework.NetworkManager gen_to_be_invoked = (XLuaFramework.NetworkManager)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onApplyTalkExp = translator.GetDelegate<System.Action<int, long>>(L, 2);
