...
namespace XLua.CSObjectWrap
{
    ...
    public class queryTabWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(queryTab);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "_roleID", _g_get__roleID);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "_roleID", _s_set__roleID);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to queryTab constructor!");
        ...
        static int _g_get_roleID(RealStatePtr L)
        {
		    try {
                ...
                queryTab gen_to_be_invoked = (queryTab)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get__roleID(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                queryTab gen_to_be_invoked = (queryTab)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushint64(L, gen_to_be_invoked._roleID);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set__roleID(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                queryTab gen_to_be_invoked = (queryTab)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked._roleID = LuaAPI.lua_toint64(L, 2);
