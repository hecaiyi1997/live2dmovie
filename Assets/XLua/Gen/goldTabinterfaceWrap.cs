...
namespace XLua.CSObjectWrap
{
    ...
    public class goldTabinterfaceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(goldTabinterface);
        ...
        {
            return LuaAPI.luaL_error(L, "goldTabinterface does not have a constructor!");
        }
        ...
        static int _g_get_uid(RealStatePtr L)
        {
		    try {
                ...
                goldTabinterface gen_to_be_invoked = (goldTabinterface)translator.FastGetCSObj(L, 1);
