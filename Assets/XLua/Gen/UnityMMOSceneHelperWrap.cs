...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOSceneHelperWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetSceneObjectPos", _m_GetSceneObjectPos_xlua_st_);
        ...
        static int _m_changehp_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityMMO.SceneHelper.changehp( _num );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetSceneObjectPos_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    long _uid = LuaAPI.lua_toint64(L, 1);
                        ...
                        UnityEngine.Vector3 gen_ret = UnityMMO.SceneHelper.GetSceneObjectPos( _uid );
