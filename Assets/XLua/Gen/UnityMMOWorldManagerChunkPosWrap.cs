...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityMMOWorldManagerChunkPosWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(UnityMMO.WorldManager.ChunkPos);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(UnityMMO.WorldManager.ChunkPos));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityMMO.WorldManager.ChunkPos constructor!");
        ...
        static int _g_get_x(RealStatePtr L)
        {
		    try {
                ...
                UnityMMO.WorldManager.ChunkPos gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
