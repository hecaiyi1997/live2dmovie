...
function Update(deltaTime, unscaledDeltaTime,Complete,Start)
	if Complete then		
		--GlobalEventSystem:Fire(NetDispatcher.Event.PlayAudioComplete)
		print("event PlayAudioComplete")
	end
	if Start then
		--GlobalEventSystem:Fire(NetDispatcher.Event.PlayAudioStart)
		print("event PlayAudioStart")
	end
...
function onStartTrgger()
    print("onStartTrgger")
    GlobalEventSystem:Fire(GlobalEvents.GameStart)
end
function onKillMonster(role_id,monsterid,num)
    print("onKillMonster")
    GlobalEventSystem:Fire(GlobalEvents.onKillMonster,role_id,monsterid,num)
end
function onsceneloadedTrgger()
    print("onsceneloadedTrgger")
    GlobalEventSystem:Fire(GlobalEvents.onsceneloaded)
end

function onMoveStart()
    print("onMoveStart")
    GlobalEventSystem:Fire(GlobalEvents.MoveStart)
end

function finishplayaction()
    print("finishplayaction")
    GlobalEventSystem:Fire(GlobalEvents.finishplayaction)
end

function talkDialogcompleted()
    print("LUa TaskDialogView:talkDialogcompleted*******")
    GlobalEventSystem:Fire(GlobalEvents.talkDialogcompleted)
end
