...
local config = {
	[1] = {
		...
		subTasks = {
			{
				subType = 1, sceneID=1001, contentID=2000,UID= 20000000001, content = {--如果是subType1则执行人是speeker
					{who=0,speeker=10000000001,to=20000000001,chat=[[好啊,没有问题,但是你能给我什么好处0?]],flag=1},
					{who=2000,speeker=20000000001,to=10000000001,chat=[[我是中心村的,我们村来了很多魔鬼,你能帮我消灭他们吗1?]], flag=1},
					{who=0,speeker=10000000001,to=20000000001,chat=[[好啊,没有问题,但是你能给我什么好处2?]],flag=1}, 
					{who=2000,speeker=20000000001,to=10000000001, chat=[[我选举你做中心村的盟主+扛把子...3]],flag=1},
					{who=0,speeker=10000000001,to=20000000001,chat=[[好啊,没有问题,但是你能给我什么好处4?]],flag=1}, 
					{who=2000,speeker=20000000001,to=10000000001, chat=[[我选举你做中心村的盟主+扛把子...5]],flag=1},
					{who=0,speeker=10000000001,to=20000000001,chat=[[好啊,没有问题,但是你能给我什么好处6?]],flag=2}, 
					--{who=2000,speeker=20000000001,to=10000000001, chat=[[我选举你做中心村的盟主+扛把子...7]],flag=2},
				},
			},
			{-------flag=1是继续对话，2是接取下一个子任务，3是完成该系列子任务，如果是subType3则执行人是UID
				subType = 3, sceneID=1001, contentID=1000,UID= 10000000001,maxProgress=1,actionID=2,flag=2--对应一个timeline1*100000+1*10000+(actionID-1)*100
				--subType = 1, sceneID=1001, contentID=2000,UID= 20000000002, content = {
				--	{who=0,speeker=10000000001,to=20000000002, chat=[[我把怪物都打掉了,快叫我盟主吧1]],flag=1},
				--	{who=2000,speeker=20000000002,to=10000000001, chat=[[盟主，扛把子...2]],flag=2},
				--},
			},
			{
				subType = 1, sceneID=1001, contentID=2000,UID= 20000000001, content = {
					{who=0, speeker=10000000001,to=20000000001,chat=[[以后我们一起愉快的玩吧1]],flag=1},
					{who=2000, speeker=20000000001,to=10000000001,chat=[[好,学怪了.2]],flag=1},
					{who=0, speeker=10000000001,to=20000000001,chat=[[我走了,再见了3]],flag=3},
				},
			},
		},
	},
	[2] = {
		...
		subTasks = {
			{
				subType = 1, sceneID=1001, contentID=2000,UID= 20000000002, content = {
					{who=2000,speeker=20000000002,to=10000000001, chat=[[我被那些怪物欺负了,可以帮我教训它们吗?1]],flag=1},
					{who=0, speeker=10000000001,to=20000000002,chat=[[看你这么骚,好吧2]],flag=1}, 
					{who=2000,speeker=20000000002,to= 10000000001,chat=[[就喜欢你这么直接的...3]], flag=2},
				},
			},
			{
				--subType = 2, sceneID=1001, contentID=2002, maxProgress=10
				subType = 1,speeker=10000000001, sceneID=1001, contentID=2000,UID= 20000000001, content = {
					{who=0, speeker=10000000001,to=20000000001,chat=[[我把怪物都打掉了,快叫我盟主吧1]], flag=1},
					{who=2000,speeker=20000000001,to=10000000001, chat=[[盟主，扛把子...2]], flag=2},
				},
			},
			{
				subType = 1, sceneID=1001, contentID=2000,UID= 20000000002, content = {
					{who=0, speeker=10000000001,to=20000000002,chat=[[我帮你收拾它们了,给我一个吻吧1]],flag=1},
					{who=2000, speeker=20000000002,to=10000000001,chat=[[你确定吗?我是人妖2]], flag=3},
				},
			},
		},
	},
	[3] = {
		...
		subTasks = {
			{
				subType = 1, sceneID=1001, contentID=2000,UID= 20000000001, content = {
					{who=2000,speeker=20000000001,to=10000000001, chat=[[虽然我是剑客,但我答应过我师傅不再动刀的?1]],flag=1},
					{who=0,speeker=10000000001,to= 20000000001,chat=[[说吧，被谁打了?2]],flag=1}, 
					{who=2000, speeker=20000000001,to=10000000001,chat=[[呜,是断头鬼3]],flag=2},
				},
			},
			{
				subType = 2, sceneID=1001, contentID=2003, maxProgress=8
			},
			{
